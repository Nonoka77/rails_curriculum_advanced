...
class Article < ApplicationRecord
  ...
  enum eyecatch_align: { left: 0, center: 1, right: 2 } # 画像の位置を設定する
  ...
  validates :eyecatch_width, numericality: { only_integer: true, greater_than_or_equal_to: 100, less_than_or_equal_to: 700, allow_blank: true } # 画像サイズを調整する
