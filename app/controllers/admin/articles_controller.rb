class Admin::ArticlesController < ApplicationController
  ...
  def article_params
    params.require(:article).permit(
      :title, :description, :slug, :state, :published_at, :eye_catch, :category_id, :author_id, :eyecatch_width, :eyecatch_align, tag_ids: []
    )
  end

  def search_params
    params[:q]&.permit(:title, :category_id, :author_id, :body, :article_id, :tag_id)
  end
